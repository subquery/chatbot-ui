...
export const ChatMessage: FC<Props> = memo(
  ({ message, maxImg, messageIndex, onRegenerate, onEdit }) => {
    ...
    const handleEditMessage = () => {
      ...
      if (messageImageList.length > 0) {
        if (
          oldData['imgList'].length === 0 ||
          messageImageList.length !== oldData['imgList'].length
        ) {
          imgChange = true;
        }
    ...
    const copyOnClick = () => {
      ...
      navigator.clipboard
        .writeText(getContentData(message.content)['text'])
        .then(() => {
                ...
                {isEditing ? (
                    ...
                    <div className="flex">
                      ...
                      <div
                        ...
                        className={
                          ...
                          (messageImageList.length >= maxImg ? ' hidden' : '')
                        }
                        onClick={() => {
                  ...
                  <div className="prose whitespace-pre-wrap dark:prose-invert flex-1">
                    ...
                    <div className="flex items-center">
                      {getContentData(message.content)['imgList'].map(
                        (imageSrc, index) => (
                          <div
                            key={index}
